...
<title>
    <?php if (isset($singleImage)) : ?>
        ...
        $description = sprintf(ngettext("%d Like", "%d Likes", $singleImage->likes), $singleImage->likesNb) . ", " . sprintf(ngettext("%d Comment", "%d Comments", $singleImage->commentsNb), $singleImage->commentsNb) . " - " . $title;
        echo $title;
        ?>
    <?php else : ?>
