            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text"><?= $singleImage->getShortDesc() ?><br><small>@<?= $userInfo->username ?></small></p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    ...
                                    <form action="/react/<?= $singleImage->id ?>" method="POST" class="image-like">
                                        <button type="submit" class="btn btn-sm btn-outline-secondary"><?= _("Like") ?><?= " (" . $singleImage->likes . ")"?></button>
                                    </form>
                                </div>
